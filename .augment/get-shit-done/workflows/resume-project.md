...
<required_reading>
@/Volumes/T7/repos/slidastro/.augment/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/Volumes/T7/repos/slidastro/.augment/get-shit-done/bin/gsd-tools.cjs" init resume)
