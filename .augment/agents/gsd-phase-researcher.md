...
```bash
node "/Volumes/T7/repos/slidastro/.augment/get-shit-done/bin/gsd-tools.cjs" websearch "your query" --limit 10
```
...
@/Volumes/T7/repos/slidastro/.augment/get-shit-done/references/thinking-models-research.md
...
```bash
node "/Volumes/T7/repos/slidastro/.augment/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): research phase domain" --files "$PHASE_DIR/$PADDED_PHASE-RESEARCH.md"
```
