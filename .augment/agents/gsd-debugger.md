...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Volumes/T7/repos/slidastro/.augment
                  → checks /Volumes/T7/repos/slidastro/.augment/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Volumes/T7/repos/slidastro/.augment/get-shit-done
                  → writes to /Volumes/T7/repos/slidastro/.augment/get-shit-done/hooks/
...
@/Volumes/T7/repos/slidastro/.augment/get-shit-done/references/thinking-models-debug.md
...
- Read @/Volumes/T7/repos/slidastro/.augment/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Volumes/T7/repos/slidastro/.augment/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Volumes/T7/repos/slidastro/.augment/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Volumes/T7/repos/slidastro/.augment/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
