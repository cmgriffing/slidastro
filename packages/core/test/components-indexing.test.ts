...
`;
    ...
    expect(html).toContain('<p class="slidastro-click slidastro-click-hidden" data-step-click="1+">Item 1</p>');
    expect(html).toContain('<p class="slidastro-click slidastro-click-hidden" data-step-click="2+">Item 2</p>');
  });
...
`;
    const { html } = await renderSlide(content);
    expect(html).toContain('<p class="slidastro-click slidastro-click-hidden" data-step-click="1">State 1</p>');
    expect(html).toContain('<p class="slidastro-click slidastro-click-hidden" data-step-click="2">State 2</p>');
  });
