...
<reference>
@/Volumes/T7/repos/slidastro/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Volumes/T7/repos/slidastro/.claude/get-shit-done/references/user-profiling.md` to load:
