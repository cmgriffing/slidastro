...
Reference full template: `/Volumes/T7/repos/slidastro/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Volumes/T7/repos/slidastro/.opencode/get-shit-done/templates/state.md`.
