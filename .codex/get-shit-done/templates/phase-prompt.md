...
<!-- For checkpoint task examples and patterns, see @/Volumes/T7/repos/slidastro/.codex/get-shit-done/references/checkpoints.md -->
...
See `/Volumes/T7/repos/slidastro/.codex/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Volumes/T7/repos/slidastro/.codex/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Volumes/T7/repos/slidastro/.codex/get-shit-done/workflows/verify-phase.md` for verification logic.
