...
- @/Volumes/T7/repos/slidastro/.codex/get-shit-done/workflows/complete-milestone.md (main workflow)
- @/Volumes/T7/repos/slidastro/.codex/get-shit-done/templates/milestone-archive.md (archive template)
  </execution_context>
