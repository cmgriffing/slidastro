...
<execution_context>
@/Volumes/T7/repos/slidastro/.codex/get-shit-done/workflows/add-todo.md
</execution_context>
...
<process>
**Follow the add-todo workflow** from `@/Volumes/T7/repos/slidastro/.codex/get-shit-done/workflows/add-todo.md`.
