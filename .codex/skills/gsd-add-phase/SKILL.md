...
<execution_context>
@/Volumes/T7/repos/slidastro/.codex/get-shit-done/workflows/add-phase.md
</execution_context>
...
<process>
**Follow the add-phase workflow** from `@/Volumes/T7/repos/slidastro/.codex/get-shit-done/workflows/add-phase.md`.
