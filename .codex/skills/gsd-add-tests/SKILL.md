...
<execution_context>
@/Volumes/T7/repos/slidastro/.codex/get-shit-done/workflows/add-tests.md
</execution_context>
...
<process>
Execute the add-tests workflow from @/Volumes/T7/repos/slidastro/.codex/get-shit-done/workflows/add-tests.md end-to-end.
