...
<execution_context>
@/Volumes/T7/repos/slidastro/.codex/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@/Volumes/T7/repos/slidastro/.codex/get-shit-done/workflows/check-todos.md`.
